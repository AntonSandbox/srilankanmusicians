  ...
  return (
    <>
      <Dialog open={isOpen} onOpenChange={setIsOpen}>
        ...
        <DialogContent showCloseButton={false} className="sm:max-w-[90vw] md:max-w-[80vw] lg:max-w-[60vw] xl:max-w-[50vw] w-full max-h-[calc(100dvh-4rem)] overflow-y-auto p-0 gap-0 border-0 bg-white dark:bg-zinc-950">
          ...
          <div className="relative h-48 sm:h-64 bg-[#1A2530] flex items-center justify-center overflow-hidden">
            {isLoadingFull && triggerType === 'profile-card' ? (
              <div className="text-amber-500 font-mono text-sm opacity-50 flex items-center gap-2">
          ...
          {isLoadingFull && triggerType === 'profile-card' ? (
            <div className="p-8 sm:p-12 space-y-10 animate-pulse">
              <div>
              ...
              <div className="bg-[#FAF7F2] dark:bg-amber-950/20 border border-amber-200/50 p-6 rounded-lg grid grid-cols-2 md:grid-cols-3 gap-6">
                <div className="col-span-2">
                  <div className="h-3 w-24 bg-amber-200/50 dark:bg-amber-900/50 rounded mb-2"></div>
                  <div className="h-8 w-40 bg-amber-200/50 dark:bg-amber-900/50 rounded"></div>
                </div>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                <div>
                  <div className="h-3 w-24 bg-zinc-200 dark:bg-zinc-800 rounded mb-4"></div>
                ...
                <div>
                  <div className="h-3 w-32 bg-zinc-200 dark:bg-zinc-800 rounded mb-4"></div>
              ...
              <div className="bg-[#FAF7F2] dark:bg-amber-950/20 border border-amber-200/50 p-6 rounded-lg">
                <div className="h-4 w-48 bg-amber-200/50 dark:bg-amber-900/50 rounded mb-4"></div>
                <div className="h-4 w-64 bg-zinc-200 dark:bg-zinc-800 rounded mb-6"></div>
                <div className="flex flex-wrap gap-2">
                  {Array.from({ length: 30 }).map((_, i) => (
                    <div key={i} className="w-8 h-8 bg-zinc-200 dark:bg-zinc-800 rounded"></div>
                  ))}
                </div>
              </div>
            </div>
              ...
              {(() => {
                ...
                return isRange ? (
                  ...
                  <div className="col-span-2">
                    ...
                    <div className="text-2xl font-mono font-medium">{popupVendor.budget_range || 'Contact for pricing'}</div>
                  </div>
                );
              })()}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              ...
              {popupVendor.location && (
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    <span className="px-3 py-1.5 border border-zinc-200 dark:border-zinc-800 rounded text-sm text-zinc-600 dark:text-zinc-300 bg-white dark:bg-zinc-900">{popupVendor.location}</span>
                  </div>
                </div>
              )}
              ...
              {popupVendor.languages && popupVendor.languages.length > 0 && (
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    <span className="px-3 py-1.5 border border-zinc-200 dark:border-zinc-800 rounded text-sm text-zinc-600 dark:text-zinc-300 bg-white dark:bg-zinc-900">{popupVendor.languages.join(' + ')}</span>
                  </div>
                </div>
              )}
            </div>
