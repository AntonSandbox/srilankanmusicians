...
export function VendorDashboardClient({ vendor, availableRanges, initialReviews }: VendorDashboardClientProps) {
  ...
  return (
    <div className="space-y-6">
      {/* Tabs Navigation */}
      <div className="flex space-x-2 border-b border-[rgba(15,23,42,0.12)] pb-4 mb-2">
        <button
          onClick={() => setActiveTab('profile')}
          className={`px-5 py-2.5 rounded-md font-bold text-sm transition-colors ${activeTab === 'profile' ? 'bg-[#E8960C] text-[#0F172A]' : 'text-[#1B2740] hover:bg-[#EFEAE0]'
            }`}
        >
          Profile Settings
        </button>
        <button
          ...
          className={`px-5 py-2.5 rounded-md font-bold text-sm transition-colors ${activeTab === 'availability' ? 'bg-[#E8960C] text-[#0F172A]' : 'text-[#1B2740] hover:bg-[#EFEAE0]'
            }`}
        >
          Availability
        </button>
        <button
          ...
          className={`px-5 py-2.5 rounded-md font-bold text-sm transition-colors ${activeTab === 'reviews' ? 'bg-[#E8960C] text-[#0F172A]' : 'text-[#1B2740] hover:bg-[#EFEAE0]'
            }`}
        >
          Manage Reviews
        </button>
      ...
      <div className="grid grid-cols-1 gap-8">
        ...
        {activeTab === 'availability' && (
          <div className="bg-white p-8 rounded-lg shadow-[0_12px_30px_rgba(15,23,42,0.08)] border border-[rgba(15,23,42,0.12)] flex flex-col">
            <h2 className="text-2xl font-medium vendor-heading mb-2" style={{ color: '#0F172A' }}>Available Ranges</h2>
            ...
            <div className="flex flex-col items-center border border-gray-100 rounded-lg p-4 bg-gray-50 mb-6">
              ...
              <Button
                ...
                className="mt-6 w-full max-w-[280px] bg-[#E8960C] hover:bg-[#F5A929] text-[#0F172A] font-bold py-6 rounded-md"
              >
        ...
        {activeTab === 'reviews' && (
          <div className="col-span-1 lg:col-span-2 space-y-8">
            <div className="bg-white p-8 rounded-lg shadow-[0_12px_30px_rgba(15,23,42,0.08)] border border-[rgba(15,23,42,0.12)]">
              <h2 className="text-2xl font-medium vendor-heading mb-2" style={{ color: '#0F172A' }}>Add a Review</h2>
              ...
              <form action={(formData) => { reviewAction(formData); }} className="space-y-4 max-w-lg">
                ...
                <Button type="submit" disabled={isReviewPending} className="bg-[#E8960C] hover:bg-[#F5A929] text-[#0F172A] font-bold py-6 px-8 rounded-md mt-2">
